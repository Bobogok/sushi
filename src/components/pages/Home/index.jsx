...
function Home() {
  ...
  return (
    <main className="home">
      {mb ? (
        <div className="home__mobile-menu-elems">
          <Link to="/catalog/sets" className="home__mobile-menu-elem">
            СЕТЫ
          </Link>
          <Link to="/catalog/rolls" className="home__mobile-menu-elem">
            РОЛЛЫ
          </Link>
          <Link to="/catalog/sushi" className="home__mobile-menu-elem">
            СУШИ
          </Link>
          <Link to="/catalog/fried-rolls" className="home__mobile-menu-elem">
            ЖАРЕННЫЕ РОЛЛЫ
          </Link>
          <Link to="/catalog/baked-rolls" className="home__mobile-menu-elem">
            ЗАПЕЧЕНЫЕ РОЛЛЫ
          </Link>
          <Link to="/catalog/wok" className="home__mobile-menu-elem">
            ВОК
          </Link>
          <Link to="/catalog/sups" className="home__mobile-menu-elem">
            СУПЫ
          </Link>
          <Link to="/catalog/tempura" className="home__mobile-menu-elem">
            ТЕМПУРА
          </Link>
          <Link to="/catalog/drinks" className="home__mobile-menu-elem">
            НАПИТКИ
          </Link>
        </div>
      ) : (
        <div className="home__inner container">
          ...
          <Link to="/catalog/wok" className="home__elem wok">
            ...
            <img
              className="wok__image-leaf-top"
              src={`${process.env.PUBLIC_URL}/img/wok_top_leaf_desktop.png`}
              alt=""
            />
            <img
